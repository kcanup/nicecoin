#############################################################################
# Makefile for building: nicecoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 13. ??? 12:56:25 2015
# Project:  nicecoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe "USE_UPNP=- RELEASE=1" -o Makefile nicecoin-qt.pro
#############################################################################
...
Makefile: nicecoin-qt.pro  ../../../Qt/4.8.6/mkspecs/win32-g++-4.6/qmake.conf ../../../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) "USE_UPNP=- RELEASE=1" -o Makefile nicecoin-qt.pro
...
C:/deps/coins/nicecoin/src/leveldb/libleveldb.a: FORCE
	cd C:/deps/coins/nicecoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/deps/coins/nicecoin/src/leveldb/libleveldb.a && ranlib C:/deps/coins/nicecoin/src/leveldb/libmemenv.a
